...
const loginTemplate = '<div class="page">' +
    ...
    '<Form>' +
    '<Input input-class="user-name-input" label-text="Full name:" type="text" placeholder="Enter name"></Input>' +
    '<Input input-class="user-password-input" label-text="Password:" type="password" placeholder="Enter password"></Input>' +
